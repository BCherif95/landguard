...
public final class Heir {
    ...
    public Heir(HeirId id, String fullName, String relation, int sharePercentage, boolean validated) {
    ...
    public static Heir create(String fullName, String relation, int sharePercentage) {
        return new Heir(HeirId.generate(), fullName, relation, sharePercentage, false);
    }
