...
import { 
  ...
  AlertCircle, Trash2, Undo2, MousePointerClick
} from "lucide-react"
import { useState, useCallback, useMemo, useEffect } from "react"
import { MapContainer, TileLayer, Polygon, Marker, useMapEvents, ZoomControl, ScaleControl } from "react-leaflet"
    ...
    <div className="space-y-6 py-4">
      <div className="space-y-4">
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)} className="w-full">
          <TabsList className="grid grid-cols-2 w-full bg-white/5 border border-white/10 p-1 mb-4 h-12 rounded-xl">
